...
RSpec.describe Ability do
  context 'when the user is a main user' do
    ...
    it{ should be_able_to(:show, admin) }
    it{ should be_able_to(:create, other_user_ready_to_create) }
    it{ should be_able_to(:create, admin_ready_to_create) }
    it{ should be_able_to(:update, user_role_changed) }
    it{ should be_able_to(:update, user_active_changed) }
    it{ should be_able_to(:update, other_user) }
    it{ should be_able_to(:update, other_user_role_changed) }
    it{ should be_able_to(:update, other_user_active_changed) }
  ...
  context 'when the user is an admin or staff' do
    ...
    it{ should be_able_to(:show, admin) }
    it{ should be_able_to(:create, other_user_ready_to_create) }
    it{ should_not be_able_to(:create, admin_ready_to_create) }
    it{ should_not be_able_to(:update, user_role_changed) }
    it{ should_not be_able_to(:update, user_active_changed) }
    it{ should be_able_to(:update, other_user) }
  ...
  context 'when the user is just an user' do
    ...
    it{ should_not be_able_to(:show, admin) }
    it{ should_not be_able_to(:create, other_user_ready_to_create) }
    it{ should_not be_able_to(:create, admin_ready_to_create) }
    it{ should_not be_able_to(:show, admin) }
    it{ should_not be_able_to(:update, user_role_changed) }
    it{ should_not be_able_to(:update, user_active_changed) }
    ...
    it{ should_not be_able_to(:update, other_user_role_changed) }
    it{ should_not be_able_to(:update, other_user_active_changed) }
    it{ should_not be_able_to(:update, admin) }
    it{ should_not be_able_to(:update, admin_role_changed) }
    it{ should_not be_able_to(:update, admin_active_changed) }
